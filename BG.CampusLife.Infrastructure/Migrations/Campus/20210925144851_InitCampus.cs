...
{
    public partial class InitCampus : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoorNumber = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarriageStatus = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    Graduated = table.Column<bool>(type: "bit", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    PersonalEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    NormalizedPersonalEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    AdditionalEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    NormalizedAdditionalEmail = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    DepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    MainMajorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Locations_NationalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EntityType = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MimeType = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedKey = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    UserId3 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId4 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId5 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId6 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId7 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId8 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UserId9 = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId2",
                        column: x => x.UserId2,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId3",
                        column: x => x.UserId3,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId4",
                        column: x => x.UserId4,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId5",
                        column: x => x.UserId5,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId6",
                        column: x => x.UserId6,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId7",
                        column: x => x.UserId7,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId8",
                        column: x => x.UserId8,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Users_UserId9",
                        column: x => x.UserId9,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.ForeignKey(
                        name: "FK_SharedCalendars_Users_SharedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId2",
                table: "Properties",
                column: "UserId2");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId3",
                table: "Properties",
                column: "UserId3");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId4",
                table: "Properties",
                column: "UserId4");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId5",
                table: "Properties",
                column: "UserId5");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId6",
                table: "Properties",
                column: "UserId6");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId7",
                table: "Properties",
                column: "UserId7");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId8",
                table: "Properties",
                column: "UserId8");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_UserId9",
                table: "Properties",
                column: "UserId9");

            migrationBuilder.CreateIndex(
                name: "IX_SharedCalendars_SharedUserId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_Documents_ImageId",
                table: "Users",
                column: "ImageId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_Properties_DepartmentId",
                table: "Users",
                column: "DepartmentId",
                principalTable: "Properties",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Users_Properties_MainMajorId",
                table: "Users",
                column: "MainMajorId",
                principalTable: "Properties",
                principalColumn: "Id",
