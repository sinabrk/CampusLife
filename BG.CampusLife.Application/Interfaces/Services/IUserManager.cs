...
namespace BG.CampusLife.Application.Interfaces.Services
{
    public interface IUserManager
    {
        ...
        /// <returns></returns>
        Task<(IdentityResultHandler result, string userId)> CreateUserAsync(string email, string password, Roles role, Guid? locationId, Guid? universityId, byte gender, string firstName, string lastName);
